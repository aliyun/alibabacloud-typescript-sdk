...
import { BindAxnFixedLineRequestExtra } from "./BindAxnFixedLineRequestExtra";


export class BindAxnFixedLineRequest extends $dara.Model {
  /**
   * @remarks
   ...
   * 扩展参数
   */
  extra?: BindAxnFixedLineRequestExtra;
  /**
   * @remarks
   * 消息请求唯一标识
   * 
