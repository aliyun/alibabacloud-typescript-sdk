...
import { GetPatchBaselineResponseBodyPatchBaselineTags } from "./GetPatchBaselineResponseBodyPatchBaselineTags";


export class GetPatchBaselineResponseBodyPatchBaseline extends $dara.Model {
  /**
   * @remarks
