...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns DescribeSqlInsightStatisticResponse
   */
  async describeSqlInsightStatisticWithOptions(request: $_model.DescribeSqlInsightStatisticRequest, runtime: $dara.RuntimeOptions): Promise<$_model.DescribeSqlInsightStatisticResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.consoleContext)) {
      query["ConsoleContext"] = request.consoleContext;
    ...
    if (!$dara.isNull(request.doFillTrend)) {
    ...
    return $dara.cast<$_model.DescribeSqlInsightStatisticResponse>(await this.callApi(params, req, runtime), new $_model.DescribeSqlInsightStatisticResponse({}));
  }
   ...
   * @returns DescribeSqlInsightStatisticResponse
   */
  async describeSqlInsightStatistic(request: $_model.DescribeSqlInsightStatisticRequest): Promise<$_model.DescribeSqlInsightStatisticResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.describeSqlInsightStatisticWithOptions(request, runtime);
  }
