...
export class QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact extends $dara.Model {
  /**
   * @remarks
   * The business ID.
   * 
...
export class QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizCredentials extends $dara.Model {
  /**
   * @remarks
...
export class QueryDomainSpecialBizInfoByDomainResponseBodyModule extends $dara.Model {
  /**
   * @remarks
...
export class QueryDomainSpecialBizInfoByDomainResponseBody extends $dara.Model {
  /**
   * @remarks
