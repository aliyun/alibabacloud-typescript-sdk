...
export class CreateWordGroupResponseBodyWordErrorInfoList extends $dara.Model {
  /**
   * @remarks
...
export class CreateWordGroupResponseBody extends $dara.Model {
  /**
   * @remarks
   ...
   */
  wordErrorInfoList?: CreateWordGroupResponseBodyWordErrorInfoList[];
  static names(): { [key: string]: string } {
    return {
      code: 'Code',
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      requestId: 'string',
      success: 'boolean',
      wordErrorInfoList: { 'type': 'array', 'itemType': CreateWordGroupResponseBodyWordErrorInfoList },
    };
  }
