...
export class CreateNodeGroupConfigSpotBidPrices extends $dara.Model {
  /**
   * @remarks
...
export class CreateNodeGroupConfig extends $dara.Model {
  /**
   * @remarks
   ...
   */
  spotBidPrices?: CreateNodeGroupConfigSpotBidPrices[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      paymentType: 'string',
      privatePoolOptions: PrivatePoolOptions,
      spotBidPrices: { 'type': 'array', 'itemType': CreateNodeGroupConfigSpotBidPrices },
      spotInstanceRemedy: 'boolean',
      spotStrategy: 'string',
      subscriptionConfig: SubscriptionConfig,
      systemDisk: SystemDisk,
