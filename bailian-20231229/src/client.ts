...
export default class Client extends OpenApi {
   ...
   */
  async addChunkWithOptions(WorkspaceId: string, tmpReq: $_model.AddChunkRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.AddChunkResponse> {
    tmpReq.validate();
    let request = new $_model.AddChunkShrinkRequest({ });
    OpenApiUtil.convert(tmpReq, request);
    if (!$dara.isNull(tmpReq.field)) {
      request.fieldShrink = OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.field, "field", "json");
    }
    ...
    if (!$dara.isNull(request.fieldShrink)) {
    ...
    let params = new $OpenApiUtil.Params({
      ...
      version: "2023-12-29",
      protocol: "HTTPS",
      pathname: `/${$dara.URL.percentEncode(WorkspaceId)}/chunk/create`,
      method: "POST",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.AddChunkResponse>(await this.callApi(params, req, runtime), new $_model.AddChunkResponse({}));
  }
   ...
   * @returns AddChunkResponse
   */
  async addChunk(WorkspaceId: string, request: $_model.AddChunkRequest): Promise<$_model.AddChunkResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.addChunkWithOptions(WorkspaceId, request, headers, runtime);
  }
   ...
   */
  async listPublishedAgentWithOptions(workspaceId: string, tmpReq: $_model.ListPublishedAgentRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.ListPublishedAgentResponse> {
    tmpReq.validate();
    let request = new $_model.ListPublishedAgentShrinkRequest({ });
    OpenApiUtil.convert(tmpReq, request);
    if (!$dara.isNull(tmpReq.subTypes)) {
      request.subTypesShrink = OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.subTypes, "subTypes", "json");
    }
    ...
    if (!$dara.isNull(request.subTypesShrink)) {
