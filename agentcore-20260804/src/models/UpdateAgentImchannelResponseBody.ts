...
export class UpdateAgentIMChannelResponseBodyDataChannelConfig extends $dara.Model {
  /**
   * @remarks
...
export class UpdateAgentIMChannelResponseBodyDataCredentialSummary extends $dara.Model {
  /**
   * @remarks
...
export class UpdateAgentIMChannelResponseBodyData extends $dara.Model {
  /**
   * @remarks
   * The agent ID.
   * 
   ...
   */
  channelConfig?: UpdateAgentIMChannelResponseBodyDataChannelConfig;
  /**
   * @remarks
...
export class UpdateAgentIMChannelResponseBody extends $dara.Model {
  /**
   * @remarks
   ...
   */
  data?: UpdateAgentIMChannelResponseBodyData;
  /**
   * @remarks
