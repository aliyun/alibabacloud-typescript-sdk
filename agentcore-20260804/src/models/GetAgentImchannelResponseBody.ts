...
export class GetAgentIMChannelResponseBodyDataChannelConfig extends $dara.Model {
  /**
   * @remarks
...
export class GetAgentIMChannelResponseBodyDataCredentialSummary extends $dara.Model {
  /**
   * @remarks
...
export class GetAgentIMChannelResponseBodyData extends $dara.Model {
  /**
   * @remarks
   * The agent ID.
   * 
   ...
   */
  channelConfig?: GetAgentIMChannelResponseBodyDataChannelConfig;
  /**
   * @remarks
