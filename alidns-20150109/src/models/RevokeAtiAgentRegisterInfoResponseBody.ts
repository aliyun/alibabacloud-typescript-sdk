...
export class RevokeAtiAgentRegisterInfoResponseBodyAccessDeniedDetail extends $dara.Model {
  /**
   * @remarks
...
export class RevokeAtiAgentRegisterInfoResponseBody extends $dara.Model {
  /**
   * @remarks
