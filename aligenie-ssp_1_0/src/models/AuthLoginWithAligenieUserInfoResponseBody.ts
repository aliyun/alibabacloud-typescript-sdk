...
export class AuthLoginWithAligenieUserInfoResponseBodyResult extends $dara.Model {
  /**
   * @example
   * 1659506854230
   */
...
export class AuthLoginWithAligenieUserInfoResponseBody extends $dara.Model {
  /**
   * @example
   * 200
   */
