...
export class GetCurrentPlayingItemResponseBodyResultCover extends $dara.Model {
  /**
   * @example
   * false
   */
...
export class GetCurrentPlayingItemResponseBodyResult extends $dara.Model {
  albumName?: string;
  /**
   * @example
   * 260744
...
export class GetCurrentPlayingItemResponseBody extends $dara.Model {
  /**
   * @example
   * 200
   */
