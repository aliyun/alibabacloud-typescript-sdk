...
export class FindAllContacterResponseBodyDataContacterInfo extends $dara.Model {
...
export class FindAllContacterResponseBodyData extends $dara.Model {
  contacterInfo?: FindAllContacterResponseBodyDataContacterInfo[];
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      contacterInfo: { 'type': 'array', 'itemType': FindAllContacterResponseBodyDataContacterInfo },
    };
  }

  validate() {
    if(Array.isArray(this.contacterInfo)) {
      $dara.Model.validateArray(this.contacterInfo);
    }
    super.validate();
  }
...
export class FindAllContacterResponseBody extends $dara.Model {
  code?: string;
  data?: FindAllContacterResponseBodyData;
  message?: string;
  requestId?: string;
  success?: boolean;
  static names(): { [key: string]: string } {
