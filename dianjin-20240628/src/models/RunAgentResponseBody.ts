...
export class RunAgentResponseBodyDataResponseChoicesMessage extends $dara.Model {
  ...
  /**
   * @remarks
   * Role of the model. Fixed value: assistant.
   * 
   * @example
   * assistant
   */
  ...
  /**
   * @remarks
   * Display name of the model\\"s role.
   * 
   * @example
   * assistant
   */
...
export class RunAgentResponseBodyDataResponseChoices extends $dara.Model {
  ...
  /**
   * @remarks
   * Index number of the generated result. Default is 0.
   * 
   * @example
   * 0
   */
...
export class RunAgentResponseBodyDataResponse extends $dara.Model {
  ...
  /**
   * @remarks
   * ID generated by the system for this call.
   * 
   * @example
