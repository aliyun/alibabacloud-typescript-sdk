...
export default class Client extends OpenApi {
   ...
   */
  async getCatalogKmsGrantsWithOptions(catalog: string, request: $_model.GetCatalogKmsGrantsRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.GetCatalogKmsGrantsResponse> {
    request.validate();
    let req = new $OpenApiUtil.OpenApiRequest({
      headers: headers,
    });
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/catalogs/${$dara.URL.percentEncode(catalog)}/kms/grants`,
      method: "GET",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.GetCatalogKmsGrantsResponse>(await this.callApi(params, req, runtime), new $_model.GetCatalogKmsGrantsResponse({}));
  }
   ...
   * @returns GetCatalogKmsGrantsResponse
   */
  async getCatalogKmsGrants(catalog: string, request: $_model.GetCatalogKmsGrantsRequest): Promise<$_model.GetCatalogKmsGrantsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.getCatalogKmsGrantsWithOptions(catalog, request, headers, runtime);
  }
   ...
   */
  async getQueryWithOptions(queryId: string, request: $_model.GetQueryRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.GetQueryResponse> {
    request.validate();
    let req = new $OpenApiUtil.OpenApiRequest({
      headers: headers,
    });
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/query/${$dara.URL.percentEncode(queryId)}`,
      method: "GET",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.GetQueryResponse>(await this.callApi(params, req, runtime), new $_model.GetQueryResponse({}));
  }
   ...
   * @returns GetQueryResponse
   */
  async getQuery(queryId: string, request: $_model.GetQueryRequest): Promise<$_model.GetQueryResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.getQueryWithOptions(queryId, request, headers, runtime);
  }
   ...
   */
  async listFunctionsWithOptions(catalogId: string, database: string, request: $_model.ListFunctionsRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.ListFunctionsResponse> {
    request.validate();
    let query : {[key: string ]: any} = { };
    ...
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/${$dara.URL.percentEncode(catalogId)}/databases/${$dara.URL.percentEncode(database)}/functions`,
      method: "GET",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
   ...
   * @returns ListFunctionsResponse
   */
  async listFunctions(catalogId: string, database: string, request: $_model.ListFunctionsRequest): Promise<$_model.ListFunctionsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.listFunctionsWithOptions(catalogId, database, request, headers, runtime);
  }
   ...
   */
  async listViewDetailsWithOptions(catalogId: string, database: string, request: $_model.ListViewDetailsRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.ListViewDetailsResponse> {
    request.validate();
    let query : {[key: string ]: any} = { };
    if (!$dara.isNull(request.maxResults)) {
      query["maxResults"] = request.maxResults;
    ...
    if (!$dara.isNull(request.viewNamePattern)) {
    ...
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/${$dara.URL.percentEncode(catalogId)}/databases/${$dara.URL.percentEncode(database)}/view-details`,
      method: "GET",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.ListViewDetailsResponse>(await this.callApi(params, req, runtime), new $_model.ListViewDetailsResponse({}));
  }
   ...
   * @returns ListViewDetailsResponse
   */
  async listViewDetails(catalogId: string, database: string, request: $_model.ListViewDetailsRequest): Promise<$_model.ListViewDetailsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.listViewDetailsWithOptions(catalogId, database, request, headers, runtime);
  }
   ...
   */
  async listViewsWithOptions(catalogId: string, database: string, request: $_model.ListViewsRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.ListViewsResponse> {
    request.validate();
    let query : {[key: string ]: any} = { };
    if (!$dara.isNull(request.maxResults)) {
      query["maxResults"] = request.maxResults;
    ...
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/${$dara.URL.percentEncode(catalogId)}/databases/${$dara.URL.percentEncode(database)}/views`,
      method: "GET",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.ListViewsResponse>(await this.callApi(params, req, runtime), new $_model.ListViewsResponse({}));
  }
   ...
   * @returns ListViewsResponse
   */
  async listViews(catalogId: string, database: string, request: $_model.ListViewsRequest): Promise<$_model.ListViewsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.listViewsWithOptions(catalogId, database, request, headers, runtime);
  }
   ...
   */
  async submitQueryWithOptions(request: $_model.SubmitQueryRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.SubmitQueryResponse> {
    request.validate();
    let body : {[key: string ]: any} = { };
    ...
    return $dara.cast<$_model.SubmitQueryResponse>(await this.callApi(params, req, runtime), new $_model.SubmitQueryResponse({}));
  }
   ...
   * @returns SubmitQueryResponse
   */
  async submitQuery(request: $_model.SubmitQueryRequest): Promise<$_model.SubmitQueryResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
   ...
   */
  async updateVpcConfigWithOptions(request: $_model.UpdateVpcConfigRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.UpdateVpcConfigResponse> {
    request.validate();
    let body : {[key: string ]: any} = { };
    if (!$dara.isNull(request.removals)) {
      body["removals"] = request.removals;
    ...
    return $dara.cast<$_model.UpdateVpcConfigResponse>(await this.callApi(params, req, runtime), new $_model.UpdateVpcConfigResponse({}));
  }
   ...
   * @returns UpdateVpcConfigResponse
   */
  async updateVpcConfig(request: $_model.UpdateVpcConfigRequest): Promise<$_model.UpdateVpcConfigResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.updateVpcConfigWithOptions(request, headers, runtime);
  }
   ...
   */
  async verifyCatalogKmsWithOptions(catalog: string, request: $_model.VerifyCatalogKmsRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.VerifyCatalogKmsResponse> {
    request.validate();
    let body : {[key: string ]: any} = { };
    ...
    let params = new $OpenApiUtil.Params({
      ...
      version: "2025-03-10",
      protocol: "HTTPS",
      pathname: `/dlf/v1/catalogs/${$dara.URL.percentEncode(catalog)}/kms/verify`,
      method: "POST",
      authType: "AK",
      style: "ROA",
      reqBodyType: "json",
    ...
    return $dara.cast<$_model.VerifyCatalogKmsResponse>(await this.callApi(params, req, runtime), new $_model.VerifyCatalogKmsResponse({}));
  }
   ...
   * @returns VerifyCatalogKmsResponse
   */
  async verifyCatalogKms(catalog: string, request: $_model.VerifyCatalogKmsRequest): Promise<$_model.VerifyCatalogKmsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.verifyCatalogKmsWithOptions(catalog, request, headers, runtime);
  }
