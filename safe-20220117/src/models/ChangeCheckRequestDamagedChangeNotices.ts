...
import { ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers } from "./ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers";


export class ChangeCheckRequestDamagedChangeNotices extends $dara.Model {
  bgCancelNoticeContent?: string;
  bgCancelNoticeEventId?: string;
  channel?: string[];
  content?: string;
  eventId?: string;
  sensitiveCustomers?: ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers[];
  type?: string;
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      content: 'string',
      eventId: 'string',
      sensitiveCustomers: { 'type': 'array', 'itemType': ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers },
      type: 'string',
    };
  }
