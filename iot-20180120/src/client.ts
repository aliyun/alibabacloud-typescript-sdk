...
export class ListSourceReplicaRequest extends $tea.Model {
...
export class ListSourceReplicaShrinkRequest extends $tea.Model {
...
export class ListSourceReplicaResponse extends $tea.Model {
  requestId: string;
  success: boolean;
  code: string;
  errorMessage: string;
  data: ListSourceReplicaResponseData;
  static names(): { [key: string]: string } {
    return {
      requestId: 'RequestId',
      success: 'Success',
...
export class ListSourceReplicaResponseDataDataList extends $tea.Model {
  replicaUid: string;
  name: string;
  code: string;
  sourceUid: string;
...
export class ListSourceReplicaResponseData extends $tea.Model {
  total: number;
  totalPage: number;
  pageSize: number;
  pageNo: number;
  dataList: ListSourceReplicaResponseDataDataList[];
  static names(): { [key: string]: string } {
    return {
      total: 'Total',
      totalPage: 'TotalPage',
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      pageSize: 'number',
      pageNo: 'number',
      dataList: { 'type': 'array', 'itemType': ListSourceReplicaResponseDataDataList },
    };
  }
...
export default class Client extends RPC {
  ...
  async listSourceReplicaWithOptions(tmp: ListSourceReplicaRequest, runtime: $Util.RuntimeOptions): Promise<ListSourceReplicaResponse> {
    Util.validateModel(tmp);
    let request = new ListSourceReplicaShrinkRequest({ });
    RPCUtil.convert(tmp, request);
    if (!Util.isUnset(tmp.context)) {
      request.contextShrink = Util.toJSONString(tmp.context);
    }

    return $tea.cast<ListSourceReplicaResponse>(await this.doRequest("ListSourceReplica", "HTTPS", "POST", "2018-01-20", "AK", null, $tea.toMap(request), runtime), new ListSourceReplicaResponse({}));
  }

  async listSourceReplica(request: ListSourceReplicaRequest): Promise<ListSourceReplicaResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.listSourceReplicaWithOptions(request, runtime);
  }
