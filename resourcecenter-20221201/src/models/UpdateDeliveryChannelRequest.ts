...
export class UpdateDeliveryChannelRequestDeliveryChannelFilter extends $dara.Model {
  /**
   * @remarks
...
export class UpdateDeliveryChannelRequestResourceChangeDeliverySlsProperties extends $dara.Model {
  /**
   * @remarks
...
export class UpdateDeliveryChannelRequestResourceSnapshotDeliverySlsProperties extends $dara.Model {
  /**
   * @remarks
   * The ARN of the destination to which large files are delivered.
   * 
