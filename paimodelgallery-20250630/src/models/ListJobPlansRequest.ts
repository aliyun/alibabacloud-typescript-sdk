...
export class ListJobPlansRequestTag extends $dara.Model {
  /**
   * @remarks
   * The tag key.
   * 
...
export class ListJobPlansRequest extends $dara.Model {
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      pageSize: 'number',
      sortBy: 'string',
      tag: { 'type': 'array', 'itemType': ListJobPlansRequestTag },
      templateId: 'string',
      workspaceId: 'string',
    };
  }
