...
export class UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource extends $dara.Model {
  containerRef?: string;
...
export class UpdateNamespaceScopeSidecarConfigRequest extends $dara.Model {
  /**
   * @remarks
   ...
   */
  SMCEnabled?: boolean;
  scaledSidecarResource?: UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource;
  /**
   * @remarks
