...
export class ClinkUpdateClientResponseBodyDataClientClidArea extends $dara.Model {
  /**
   * @remarks
   * 地区组名称
   * 
...
export class ClinkUpdateClientResponseBodyDataClientPermission extends $dara.Model {
  /**
   * @remarks
...
export class ClinkUpdateClientResponseBodyDataClient extends $dara.Model {
  /**
   * @remarks
   * 启用状态，0: 停用；1: 启用
   * 
   ...
   * 给地区指定可外显号码
   */
  clidArea?: ClinkUpdateClientResponseBodyDataClientClidArea[];
  /**
   * @remarks
   ...
   * permission
   */
  permission?: ClinkUpdateClientResponseBodyDataClientPermission;
  /**
   * @remarks
   * 所属队列号集合
   */
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      clidArea: { 'type': 'array', 'itemType': ClinkUpdateClientResponseBodyDataClientClidArea },
...
export class ClinkUpdateClientResponseBodyData extends $dara.Model {
  client?: ClinkUpdateClientResponseBodyDataClient;
  /**
   * @remarks
   * 请求 id
   * 
...
export class ClinkUpdateClientResponseBody extends $dara.Model {
   ...
   */
  code?: string;
  data?: ClinkUpdateClientResponseBodyData;
  /**
   * @example
   * OK
   */
