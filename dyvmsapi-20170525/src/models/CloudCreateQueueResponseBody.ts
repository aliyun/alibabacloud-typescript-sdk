...
export class CloudCreateQueueResponseBodyDataQueue extends $dara.Model {
  /**
   * @remarks
...
export class CloudCreateQueueResponseBodyDataQueueSkills extends $dara.Model {
  /**
   * @remarks
   * 创建时间，格式: yyyy-MM-dd HH:mm:ss
   * 
...
export class CloudCreateQueueResponseBodyData extends $dara.Model {
  /**
   * @remarks
   * 队列配置信息
   */
  queue?: CloudCreateQueueResponseBodyDataQueue;
  /**
   * @remarks
   * 队列所需技能数组
   */
  queueSkills?: CloudCreateQueueResponseBodyDataQueueSkills[];
  static names(): { [key: string]: string } {
    return {
      queue: 'Queue',
  ...
  static types(): { [key: string]: any } {
    return {
      queue: CloudCreateQueueResponseBodyDataQueue,
      queueSkills: { 'type': 'array', 'itemType': CloudCreateQueueResponseBodyDataQueueSkills },
    };
  }
...
export class CloudCreateQueueResponseBody extends $dara.Model {
   ...
   */
  code?: string;
  data?: CloudCreateQueueResponseBodyData;
  /**
   * @example
   * OK
   */
