...
export class CloudGetExtenResponseBodyData extends $dara.Model {
  /**
   * @remarks
   * 语音编码
   * 
...
export class CloudGetExtenResponseBody extends $dara.Model {
   ...
   */
  code?: string;
  data?: CloudGetExtenResponseBodyData;
  /**
   * @example
   * OK
   */
