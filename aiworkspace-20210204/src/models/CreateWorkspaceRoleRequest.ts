...
export class CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules extends $dara.Model {
  /**
   * @remarks
...
export class CreateWorkspaceRoleRequestModulePermissionsPermissions extends $dara.Model {
  /**
   * @remarks
   ...
   */
  permissionRules?: CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules[];
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      permissionRules: { 'type': 'array', 'itemType': CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules },
    };
  }
...
export class CreateWorkspaceRoleRequestModulePermissions extends $dara.Model {
  /**
   * @remarks
   ...
   */
  permissions?: CreateWorkspaceRoleRequestModulePermissionsPermissions[];
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      moduleName: 'string',
      permissionType: 'string',
      permissions: { 'type': 'array', 'itemType': CreateWorkspaceRoleRequestModulePermissionsPermissions },
    };
  }
