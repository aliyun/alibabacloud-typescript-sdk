...
export class DescribeVodPlayerMetricDataDemoResponseBodyDataList extends $dara.Model {
  /**
   * @example
   * 2
   */
...
export class DescribeVodPlayerMetricDataDemoResponseBodyExtend extends $dara.Model {
  /**
   * @example
...
export class DescribeVodPlayerMetricDataDemoResponseBody extends $dara.Model {
  dataList?: DescribeVodPlayerMetricDataDemoResponseBodyDataList[];
  extend?: DescribeVodPlayerMetricDataDemoResponseBodyExtend;
  /**
   * @example
   * 1
   */
  ...
  static types(): { [key: string]: any } {
    return {
      dataList: { 'type': 'array', 'itemType': DescribeVodPlayerMetricDataDemoResponseBodyDataList },
      extend: DescribeVodPlayerMetricDataDemoResponseBodyExtend,
      pageNumber: 'number',
      pageSize: 'number',
      requestId: 'string',
