...
export class DescribeVodTagResourcesResponseBodyTagResourcesTag extends $dara.Model {
  key?: string;
  value?: string;
...
export class DescribeVodTagResourcesResponseBodyTagResources extends $dara.Model {
  resourceId?: string;
...
export class DescribeVodTagResourcesResponseBody extends $dara.Model {
  requestId?: string;
