...
export class RunContinueContentResponseBodyHeader extends $dara.Model {
  /**
   * @example
   * 403
   */
...
export class RunContinueContentResponseBodyPayloadOutput extends $dara.Model {
  /**
   * @example
   * 这是测试输出
   */
...
export class RunContinueContentResponseBodyPayloadUsage extends $dara.Model {
  /**
   * @example
   * 100
   */
