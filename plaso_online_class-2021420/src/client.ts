...
export default class Client extends OpenApi {
  ...
  async endCallbackWithOptions(request: EndCallbackRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<EndCallbackResponse> {
    ...
    return $tea.cast<EndCallbackResponse>(await this.doROARequestWithForm("EndCallback", "2021-4-20", "HTTPS", "POST", "AK", `/plaso/roa`, "json", req, runtime), new EndCallbackResponse({}));
  }
