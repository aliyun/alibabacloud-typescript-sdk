...
export class GetExpressConnectRouterRequest extends $tea.Model {
  clientToken?: string;
  dryRun?: boolean;
  ecrId?: string;
  static names(): { [key: string]: string } {
...
export class GetExpressConnectRouterResponseBody extends $tea.Model {
  accessDeniedDetail?: string;
  alibabaSideAsn?: number;
  bizStatus?: string;
  code?: string;
  ...
  status?: string;
  success?: boolean;
  tags?: GetExpressConnectRouterResponseBodyTags[];
  static names(): { [key: string]: string } {
    return {
      accessDeniedDetail: 'AccessDeniedDetail',
      alibabaSideAsn: 'AlibabaSideAsn',
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      status: 'string',
      success: 'boolean',
      tags: { 'type': 'array', 'itemType': GetExpressConnectRouterResponseBodyTags },
    };
  }
...
export class GetExpressConnectRouterResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: GetExpressConnectRouterResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class GetExpressConnectRouterResponseBodyTags extends $tea.Model {
  aliUid?: number;
  category?: number;
  id?: number;
  regionNo?: string;
...
export default class Client extends OpenApi {
  ...
  async getExpressConnectRouterWithOptions(request: GetExpressConnectRouterRequest, runtime: $Util.RuntimeOptions): Promise<GetExpressConnectRouterResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.clientToken)) {
      body["ClientToken"] = request.clientToken;
    ...
    return $tea.cast<GetExpressConnectRouterResponse>(await this.callApi(params, req, runtime), new GetExpressConnectRouterResponse({}));
  }

  async getExpressConnectRouter(request: GetExpressConnectRouterRequest): Promise<GetExpressConnectRouterResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getExpressConnectRouterWithOptions(request, runtime);
  }
