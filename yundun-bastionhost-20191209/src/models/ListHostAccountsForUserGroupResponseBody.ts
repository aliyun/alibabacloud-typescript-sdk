...
import { ListHostAccountsForUserGroupResponseBodyHostAccounts } from "./ListHostAccountsForUserGroupResponseBodyHostAccounts";


export class ListHostAccountsForUserGroupResponseBody extends $dara.Model {
  /**
   * @remarks
