...
export class ListPlaybooksRequest extends $dara.Model {
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      playbookExecutionStartTime: 'number',
      playbookName: 'string',
      playbookParamTypes: { 'type': 'array', 'itemType': 'string' },
      playbookStatus: 'number',
      playbookType: 'string',
      playbookUuids: { 'type': 'array', 'itemType': 'string' },
      roleFor: 'number',
    };
  }

  validate() {
    if(Array.isArray(this.playbookParamTypes)) {
      $dara.Model.validateArray(this.playbookParamTypes);
    }
    if(Array.isArray(this.playbookUuids)) {
      $dara.Model.validateArray(this.playbookUuids);
    }
    super.validate();
  }
