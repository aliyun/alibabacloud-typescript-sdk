...
import { DescribeCollectorResponseBodyResultExtendConfigsMachines } from "./DescribeCollectorResponseBodyResultExtendConfigsMachines";


export class DescribeCollectorResponseBodyResultExtendConfigs extends $dara.Model {
  /**
   * @remarks
