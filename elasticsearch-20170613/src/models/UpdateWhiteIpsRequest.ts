...
export class UpdateWhiteIpsRequestWhiteIpGroup extends $dara.Model {
  ...
  /**
   * @remarks
   * The type of the IP whitelist. The value is fixed as **PRIVATE_ES**, which indicates the private network access whitelist.
   * 
   * @example
   * PRIVATE_ES
   */
...
export class UpdateWhiteIpsRequest extends $dara.Model {
   ...
   * 
   * - Cover (default): overwrites the IP addresses in the original whitelist with the values specified in the ips parameter.
   * 
