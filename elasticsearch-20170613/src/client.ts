...
export class RpcListInstanceRequest extends $tea.Model {
  esVersion?: string;
  vpcId?: string;
  vswitchId?: string;
  static names(): { [key: string]: string } {
...
export class RpcListInstanceResponseBody extends $tea.Model {
  requestId?: string;
  result?: RpcListInstanceResponseBodyResult[];
  static names(): { [key: string]: string } {
    return {
      requestId: 'requestId',
      result: 'Result',
  ...
  static types(): { [key: string]: any } {
    return {
      requestId: 'string',
      result: { 'type': 'array', 'itemType': RpcListInstanceResponseBodyResult },
    };
  }
...
export class RpcListInstanceResponse extends $tea.Model {
  headers: { [key: string]: string };
  body: RpcListInstanceResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      body: 'body',
...
export class RpcListInstanceResponseBodyResult extends $tea.Model {
  advancedDedicateMaster?: boolean;
  createdAt?: string;
  dataNode?: boolean;
  dedicateMaster?: boolean;
...
export default class Client extends OpenApi {
  ...
  async startApmWithOptions(instanceId: string, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<StartApmResponse> {
    ...
    return $tea.cast<StartApmResponse>(await this.doROARequest("StartApm", "2017-06-13", "HTTPS", "POST", "AK", `/openapi/apm/${instanceId}/start`, "json", req, runtime), new StartApmResponse({}));
  }
  ...
  async stopApmWithOptions(instanceId: string, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<StopApmResponse> {
    ...
    return $tea.cast<StopApmResponse>(await this.doROARequest("StopApm", "2017-06-13", "HTTPS", "POST", "AK", `/openapi/apm/${instanceId}/stop`, "json", req, runtime), new StopApmResponse({}));
  }
  ...
  async rpcListInstance(request: RpcListInstanceRequest): Promise<RpcListInstanceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.rpcListInstanceWithOptions(request, headers, runtime);
  }

  async rpcListInstanceWithOptions(request: RpcListInstanceRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<RpcListInstanceResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.esVersion)) {
      query["esVersion"] = request.esVersion;
    ...
    return $tea.cast<RpcListInstanceResponse>(await this.doROARequest("RpcListInstance", "2017-06-13", "HTTPS", "POST", "AK", `/openapi/instances/rpc`, "json", req, runtime), new RpcListInstanceResponse({}));
  }
  ...
  async updateDescriptionWithOptions(InstanceId: string, request: UpdateDescriptionRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<UpdateDescriptionResponse> {
    ...
    return $tea.cast<UpdateDescriptionResponse>(await this.doROARequestWithForm("UpdateDescription", "2017-06-13", "HTTPS", "POST", "AK", `/openapi/instances/${InstanceId}/description`, "json", req, runtime), new UpdateDescriptionResponse({}));
  }
