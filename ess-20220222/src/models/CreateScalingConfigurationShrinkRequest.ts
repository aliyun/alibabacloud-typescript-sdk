...
import { CreateScalingConfigurationShrinkRequestImageOptions } from "./CreateScalingConfigurationShrinkRequestImageOptions";
import { CreateScalingConfigurationShrinkRequestPrivatePoolOptions } from "./CreateScalingConfigurationShrinkRequestPrivatePoolOptions";
import { CreateScalingConfigurationShrinkRequestSystemDisk } from "./CreateScalingConfigurationShrinkRequestSystemDisk";
import { CreateScalingConfigurationShrinkRequestCustomPriorities } from "./CreateScalingConfigurationShrinkRequestCustomPriorities";
import { CreateScalingConfigurationShrinkRequestDataDisks } from "./CreateScalingConfigurationShrinkRequestDataDisks";
import { CreateScalingConfigurationShrinkRequestInstancePatternInfos } from "./CreateScalingConfigurationShrinkRequestInstancePatternInfos";
import { CreateScalingConfigurationShrinkRequestInstanceTypeOverrides } from "./CreateScalingConfigurationShrinkRequestInstanceTypeOverrides";
import { CreateScalingConfigurationShrinkRequestNetworkInterfaces } from "./CreateScalingConfigurationShrinkRequestNetworkInterfaces";
import { CreateScalingConfigurationShrinkRequestResourcePoolOptions } from "./CreateScalingConfigurationShrinkRequestResourcePoolOptions";
import { CreateScalingConfigurationShrinkRequestSecurityOptions } from "./CreateScalingConfigurationShrinkRequestSecurityOptions";
import { CreateScalingConfigurationShrinkRequestSpotPriceLimits } from "./CreateScalingConfigurationShrinkRequestSpotPriceLimits";


export class CreateScalingConfigurationShrinkRequest extends $dara.Model {
