...
import { ModifyScalingConfigurationRequestImageOptions } from "./ModifyScalingConfigurationRequestImageOptions";
import { ModifyScalingConfigurationRequestPrivatePoolOptions } from "./ModifyScalingConfigurationRequestPrivatePoolOptions";
import { ModifyScalingConfigurationRequestSystemDisk } from "./ModifyScalingConfigurationRequestSystemDisk";
import { ModifyScalingConfigurationRequestCustomPriorities } from "./ModifyScalingConfigurationRequestCustomPriorities";
import { ModifyScalingConfigurationRequestDataDisks } from "./ModifyScalingConfigurationRequestDataDisks";
import { ModifyScalingConfigurationRequestInstancePatternInfos } from "./ModifyScalingConfigurationRequestInstancePatternInfos";
import { ModifyScalingConfigurationRequestInstanceTypeOverrides } from "./ModifyScalingConfigurationRequestInstanceTypeOverrides";
import { ModifyScalingConfigurationRequestNetworkInterfaces } from "./ModifyScalingConfigurationRequestNetworkInterfaces";
import { ModifyScalingConfigurationRequestResourcePoolOptions } from "./ModifyScalingConfigurationRequestResourcePoolOptions";
import { ModifyScalingConfigurationRequestSecurityOptions } from "./ModifyScalingConfigurationRequestSecurityOptions";
import { ModifyScalingConfigurationRequestSpotPriceLimits } from "./ModifyScalingConfigurationRequestSpotPriceLimits";


export class ModifyScalingConfigurationRequest extends $dara.Model {
