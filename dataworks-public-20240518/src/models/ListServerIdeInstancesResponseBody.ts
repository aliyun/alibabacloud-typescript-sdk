...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigsRolesUserInfo extends $dara.Model {
  /**
   * @remarks
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigsRoles extends $dara.Model {
  /**
   * @remarks
   ...
   */
  userInfo?: ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigsRolesUserInfo;
  static names(): { [key: string]: string } {
    return {
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigs extends $dara.Model {
  /**
   * @remarks
   ...
   */
  roles?: ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigsRoles[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      key: 'string',
      roles: { 'type': 'array', 'itemType': ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigsRoles },
      type: 'string',
    };
  }
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfig extends $dara.Model {
  /**
   * @remarks
   ...
   */
  configs?: ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigs[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      aliyunEnvRoleKey: 'string',
      configs: { 'type': 'array', 'itemType': ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfigConfigs },
      enable: 'boolean',
    };
  }
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesDatasets extends $dara.Model {
  /**
   * @remarks
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesUserVpcForwardInfos extends $dara.Model {
  /**
   * @remarks
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstancesUserVpc extends $dara.Model {
  /**
   * @remarks
   * The list of port forwarding configurations.
   */
  forwardInfos?: ListServerIdeInstancesResponseBodyPagingInfoInstancesUserVpcForwardInfos[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      forwardInfos: { 'type': 'array', 'itemType': ListServerIdeInstancesResponseBodyPagingInfoInstancesUserVpcForwardInfos },
      securityGroupId: 'string',
      vSwitchId: 'string',
      vpcId: 'string',
    };
...
export class ListServerIdeInstancesResponseBodyPagingInfoInstances extends $dara.Model {
  /**
   * @remarks
   ...
   */
  credentialConfig?: ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfig;
  /**
   * @remarks
   ...
   */
  datasets?: ListServerIdeInstancesResponseBodyPagingInfoInstancesDatasets[];
  /**
   * @remarks
   ...
   */
  userVpc?: ListServerIdeInstancesResponseBodyPagingInfoInstancesUserVpc;
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      credentialConfig: ListServerIdeInstancesResponseBodyPagingInfoInstancesCredentialConfig,
      cu: 'number',
      datasets: { 'type': 'array', 'itemType': ListServerIdeInstancesResponseBodyPagingInfoInstancesDatasets },
      failReason: 'string',
      imageId: 'string',
      imageName: 'string',
      imageUrl: 'string',
...
export class ListServerIdeInstancesResponseBodyPagingInfo extends $dara.Model {
  /**
   * @remarks
   * The list of personal development environment instances.
   */
  instances?: ListServerIdeInstancesResponseBodyPagingInfoInstances[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      instances: { 'type': 'array', 'itemType': ListServerIdeInstancesResponseBodyPagingInfoInstances },
      pageNumber: 'number',
      pageSize: 'number',
      totalCount: 'number',
    };
...
export class ListServerIdeInstancesResponseBody extends $dara.Model {
  /**
   * @remarks
   ...
   */
  pagingInfo?: ListServerIdeInstancesResponseBodyPagingInfo;
  /**
   * @remarks
   * The request ID.
   * 
