...
export class GetAutoScalingRuleResponseBodyData extends $dara.Model {
  configId?: string;
  enabled?: boolean;
  endTime?: string;
  instanceId?: string;
...
export class GetAutoScalingRuleResponseBody extends $dara.Model {
  accessDeniedDetail?: string;
  code?: string;
  data?: GetAutoScalingRuleResponseBodyData;
  dynamicCode?: string;
