...
export class GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList extends $dara.Model {
  address?: string;
  port?: string;
  type?: string;
...
export class GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup extends $dara.Model {
  category?: string;
  cpuCoreCount?: number;
...
export class GetLindormV2InstanceForTerraformResponseBodyEngineList extends $dara.Model {
  connectAddressList?: GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList[];
  engine?: string;
  isLastVersion?: boolean;
  latestVersion?: string;
  nodeGroup?: GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup[];
  version?: string;
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      connectAddressList: { 'type': 'array', 'itemType': GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList },
      engine: 'string',
      isLastVersion: 'boolean',
      latestVersion: 'string',
      nodeGroup: { 'type': 'array', 'itemType': GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup },
      version: 'string',
    };
  }
...
export class GetLindormV2InstanceForTerraformResponseBodyStorageUsage extends $dara.Model {
...
export class GetLindormV2InstanceForTerraformResponseBodyWhiteIpList extends $dara.Model {
  groupName?: string;
  ipList?: string;
  static names(): { [key: string]: string } {
    return {
...
export class GetLindormV2InstanceForTerraformResponseBody extends $dara.Model {
  aliUid?: number;
  ...
  engineList?: GetLindormV2InstanceForTerraformResponseBodyEngineList[];
  ...
  storageUsage?: GetLindormV2InstanceForTerraformResponseBodyStorageUsage;
  vpcId?: string;
  vswitchId?: string;
  whiteIpList?: GetLindormV2InstanceForTerraformResponseBodyWhiteIpList[];
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      diskUsage: 'string',
      enableCompute: 'boolean',
      engineList: { 'type': 'array', 'itemType': GetLindormV2InstanceForTerraformResponseBodyEngineList },
      expiredMilliseconds: 'number',
      initialRootPassword: 'string',
      instanceAlias: 'string',
      instanceId: 'string',
      ...
      vpcId: 'string',
      vswitchId: 'string',
      whiteIpList: { 'type': 'array', 'itemType': GetLindormV2InstanceForTerraformResponseBodyWhiteIpList },
