...
export class DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerIntervalDataModule extends $dara.Model {
  /**
   * @remarks
...
export class DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerInterval extends $dara.Model {
...
export class DescribeDcdnDomainIpaBpsDataResponseBody extends $dara.Model {
  /**
   * @remarks
