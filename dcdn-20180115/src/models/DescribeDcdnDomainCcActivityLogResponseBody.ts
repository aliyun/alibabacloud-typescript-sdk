...
export class DescribeDcdnDomainCcActivityLogResponseBodyActivityLog extends $dara.Model {
  /**
   * @remarks
...
export class DescribeDcdnDomainCcActivityLogResponseBody extends $dara.Model {
  /**
   * @remarks
