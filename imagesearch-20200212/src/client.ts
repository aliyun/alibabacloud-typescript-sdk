...
export default class Client extends OpenApi {
  ...
  async addImageWithOptions(request: AddImageRequest, runtime: $Util.RuntimeOptions): Promise<AddImageResponse> {
    ...
    return $tea.cast<AddImageResponse>(await this.doRPCRequest("AddImage", "2020-02-12", "HTTPS", "POST", "AK", "json", req, runtime), new AddImageResponse({}));
  }
  ...
  async deleteImageWithOptions(request: DeleteImageRequest, runtime: $Util.RuntimeOptions): Promise<DeleteImageResponse> {
    ...
    return $tea.cast<DeleteImageResponse>(await this.doRPCRequest("DeleteImage", "2020-02-12", "HTTPS", "POST", "AK", "json", req, runtime), new DeleteImageResponse({}));
  }
  ...
  async searchImageByNameWithOptions(request: SearchImageByNameRequest, runtime: $Util.RuntimeOptions): Promise<SearchImageByNameResponse> {
    ...
    return $tea.cast<SearchImageByNameResponse>(await this.doRPCRequest("SearchImageByName", "2020-02-12", "HTTPS", "POST", "AK", "json", req, runtime), new SearchImageByNameResponse({}));
  }
  ...
  async searchImageByPicWithOptions(request: SearchImageByPicRequest, runtime: $Util.RuntimeOptions): Promise<SearchImageByPicResponse> {
    ...
    return $tea.cast<SearchImageByPicResponse>(await this.doRPCRequest("SearchImageByPic", "2020-02-12", "HTTPS", "POST", "AK", "json", req, runtime), new SearchImageByPicResponse({}));
  }
