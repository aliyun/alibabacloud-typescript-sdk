...
export class QueryConvertInstancePriceRequestConvertPostpayInstanceRequestNamespaceResourceSpecsResourceSpec extends $dara.Model {
  /**
   * @remarks
...
export class QueryConvertInstancePriceRequestConvertPostpayInstanceRequestNamespaceResourceSpecs extends $dara.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class QueryConvertInstancePriceRequestConvertPostpayInstanceRequest extends $dara.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
