...
import { ListPoliciesForGroupResponseBodyPolicies } from "./ListPoliciesForGroupResponseBodyPolicies";


export class ListPoliciesForGroupResponseBody extends $dara.Model {
  /**
   * @remarks
