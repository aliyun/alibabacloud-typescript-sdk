...
export class ListAuthorizationRulesForUserResponseBodyAuthorizationRules extends $dara.Model {
  /**
   * @remarks
   * 授权规则标识。
   * 
...
export class ListAuthorizationRulesForUserResponseBody extends $dara.Model {
  ...
  static types(): { [key: string]: any } {
    return {
      authorizationRules: { 'type': 'array', 'itemType': ListAuthorizationRulesForUserResponseBodyAuthorizationRules },
      maxResults: 'number',
      nextToken: 'string',
      requestId: 'string',
      totalCount: 'number',
