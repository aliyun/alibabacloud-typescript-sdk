...
export class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyDataItems extends $dara.Model {
  /**
   * @example
   * 2022-10
   */
...
export class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData extends $dara.Model {
  /**
   * @example
   * 185766xxxx
   */
...
export class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBody extends $dara.Model {
  /**
   * @example
   * 200
   */
