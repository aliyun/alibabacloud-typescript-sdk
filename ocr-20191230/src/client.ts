...
export class RecognizePoiNameResponse extends $tea.Model {
  requestId: string;
  data: RecognizePoiNameResponseData;
  static names(): { [key: string]: string } {
    return {
      requestId: 'RequestId',
      data: 'Data',
...
export class DetectCardScreenshotResponse extends $tea.Model {
  requestId: string;
  data: DetectCardScreenshotResponseData;
  static names(): { [key: string]: string } {
    return {
      requestId: 'RequestId',
      data: 'Data',
...
export class RecognizePoiNameResponseDataSignboardsTexts extends $tea.Model {
  label: string;
  score: number;
  tag: string;
  type: string;
...
export class RecognizePoiNameResponseDataSignboards extends $tea.Model {
  texts: RecognizePoiNameResponseDataSignboardsTexts[];
  static names(): { [key: string]: string } {
    return {
      texts: 'Texts',
    };
  ...
  static types(): { [key: string]: any } {
    return {
      texts: { 'type': 'array', 'itemType': RecognizePoiNameResponseDataSignboardsTexts },
    };
  }
...
export class RecognizePoiNameResponseDataSummary extends $tea.Model {
  brand: string;
  score: number;
  static names(): { [key: string]: string } {
    return {
...
export class RecognizePoiNameResponseData extends $tea.Model {
  signboards: RecognizePoiNameResponseDataSignboards[];
  summary: RecognizePoiNameResponseDataSummary;
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      signboards: { 'type': 'array', 'itemType': RecognizePoiNameResponseDataSignboards },
      summary: RecognizePoiNameResponseDataSummary,
    };
  }
...
export class DetectCardScreenshotResponseDataSpoofResultResultMap extends $tea.Model {
  screenScore: number;
...
export class DetectCardScreenshotResponseDataSpoofResult extends $tea.Model {
  isSpoof: boolean;
  resultMap: DetectCardScreenshotResponseDataSpoofResultResultMap;
  static names(): { [key: string]: string } {
    return {
      isSpoof: 'IsSpoof',
      resultMap: 'ResultMap',
...
export class DetectCardScreenshotResponseData extends $tea.Model {
  isCard: boolean;
  isBlur: boolean;
  spoofResult: DetectCardScreenshotResponseDataSpoofResult;
  static names(): { [key: string]: string } {
    return {
      isCard: 'IsCard',
      isBlur: 'IsBlur',
...
export default class Client extends RPC {
  ...
  async recognizePoiName(request: RecognizePoiNameRequest, runtime: $Util.RuntimeOptions): Promise<RecognizePoiNameResponse> {
    Util.validateModel(request);
    return $tea.cast<RecognizePoiNameResponse>(await this.doRequest("RecognizePoiName", "HTTPS", "POST", "2019-12-30", "AK", null, $tea.toMap(request), runtime), new RecognizePoiNameResponse({}));
  }
  ...
  async recognizePoiNameAdvance(request: RecognizePoiNameAdvanceRequest, runtime: $Util.RuntimeOptions): Promise<RecognizePoiNameResponse> {
    ...
    RPCUtil.convert(request, recognizePoiNamereq);
    ...
    let recognizePoiNameResp = await this.recognizePoiName(recognizePoiNamereq, runtime);
    return recognizePoiNameResp;
  }

  async detectCardScreenshot(request: DetectCardScreenshotRequest, runtime: $Util.RuntimeOptions): Promise<DetectCardScreenshotResponse> {
    Util.validateModel(request);
    return $tea.cast<DetectCardScreenshotResponse>(await this.doRequest("DetectCardScreenshot", "HTTPS", "POST", "2019-12-30", "AK", null, $tea.toMap(request), runtime), new DetectCardScreenshotResponse({}));
  }
  ...
  async detectCardScreenshotAdvance(request: DetectCardScreenshotAdvanceRequest, runtime: $Util.RuntimeOptions): Promise<DetectCardScreenshotResponse> {
    ...
    RPCUtil.convert(request, detectCardScreenshotreq);
    authResponse = await authClient.authorizeFileUploadWithOptions(authRequest, runtime);
    ossConfig.accessKeyId = authResponse.accessKeyId;
    ossConfig.endpoint = RPCUtil.getEndpoint(authResponse.endpoint, authResponse.useAccelerate, this._endpointType);
    ossClient = new OSS(ossConfig);
    ...
    let detectCardScreenshotResp = await this.detectCardScreenshot(detectCardScreenshotreq, runtime);
