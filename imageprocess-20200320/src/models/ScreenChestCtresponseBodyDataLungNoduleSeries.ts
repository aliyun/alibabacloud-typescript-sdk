...
import { ScreenChestCTResponseBodyDataLungNoduleSeriesElements } from "./ScreenChestCtresponseBodyDataLungNoduleSeriesElements";


export class ScreenChestCTResponseBodyDataLungNoduleSeries extends $dara.Model {
