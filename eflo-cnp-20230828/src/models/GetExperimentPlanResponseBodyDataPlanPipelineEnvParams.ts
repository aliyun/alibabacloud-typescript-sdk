...
import { GetExperimentPlanResponseBodyDataPlanPipelineEnvParamsResourceNodes } from "./GetExperimentPlanResponseBodyDataPlanPipelineEnvParamsResourceNodes";


export class GetExperimentPlanResponseBodyDataPlanPipelineEnvParams extends $dara.Model {
  /**
   * @remarks
   * CPU allocation
   * 
