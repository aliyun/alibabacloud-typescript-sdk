...
export class CheckFinishMissionRequest extends $tea.Model {
  missionType?: string;
  static names(): { [key: string]: string } {
    return {
...
export class CheckFinishMissionResponseBody extends $tea.Model {
  hasFinish?: boolean;
  requestId?: string;
  errorCode?: string;
  errorMessage?: string;
...
export class CheckFinishMissionResponse extends $tea.Model {
  headers: { [key: string]: string };
  body: CheckFinishMissionResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      body: 'body',
...
export default class Client extends OpenApi {
  ...
  async checkFinishMissionWithOptions(request: CheckFinishMissionRequest, runtime: $Util.RuntimeOptions): Promise<CheckFinishMissionResponse> {
    Util.validateModel(request);
    let query = OpenApiUtil.query(Util.toMap(request));
    let req = new $OpenApi.OpenApiRequest({
      query: query,
    });
    return $tea.cast<CheckFinishMissionResponse>(await this.doRPCRequest("CheckFinishMission", "2018-11-01", "HTTPS", "GET", "AK", "json", req, runtime), new CheckFinishMissionResponse({}));
  }

  async checkFinishMission(request: CheckFinishMissionRequest): Promise<CheckFinishMissionResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.checkFinishMissionWithOptions(request, runtime);
  }
