...
export class GetUserAppEnhanceProcessInMsaResponseBodyResultContentDataEnhanceMapping extends $dara.Model {
  info?: string;
  reason?: string;
  type?: string;
...
export class GetUserAppEnhanceProcessInMsaResponseBodyResultContentData extends $dara.Model {
  afterMd5?: string;
  afterSize?: number;
  appCode?: string;
  appPackage?: string;
...
export class GetUserAppEnhanceProcessInMsaResponseBodyResultContent extends $dara.Model {
  code?: string;
...
export class GetUserAppEnhanceProcessInMsaResponseBody extends $dara.Model {
  requestId?: string;
  resultCode?: string;
