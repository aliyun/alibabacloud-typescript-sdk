...
export class StartUserAppAsyncEnhanceInMsaResponseBodyResultContentDataEnhanceMapping extends $dara.Model {
  info?: string;
  reason?: string;
  type?: string;
...
export class StartUserAppAsyncEnhanceInMsaResponseBodyResultContentData extends $dara.Model {
  afterMd5?: string;
  afterSize?: number;
  appCode?: string;
  appPackage?: string;
...
export class StartUserAppAsyncEnhanceInMsaResponseBodyResultContent extends $dara.Model {
  code?: string;
...
export class StartUserAppAsyncEnhanceInMsaResponseBody extends $dara.Model {
  requestId?: string;
  resultCode?: string;
