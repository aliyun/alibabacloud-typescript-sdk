...
export class ListMgsApiResponseBodyResultContentValueApiInvokerHttpInvoker extends $dara.Model {
  charset?: string;
  contentType?: string;
  host?: string;
  method?: string;
...
export class ListMgsApiResponseBodyResultContentValueApiInvoker extends $dara.Model {
...
export class ListMgsApiResponseBodyResultContentValueCacheRule extends $dara.Model {
  cacheKey?: string;
  needCache?: boolean;
  ttl?: number;
  static names(): { [key: string]: string } {
...
export class ListMgsApiResponseBodyResultContentValueCircuitBreakerRule extends $dara.Model {
  appId?: string;
...
export class ListMgsApiResponseBodyResultContentValueHeaderRule extends $dara.Model {
  headerKey?: string;
  location?: string;
  type?: string;
  value?: string;
...
export class ListMgsApiResponseBodyResultContentValueHeaderRules extends $dara.Model {
  headerKey?: string;
  location?: string;
  type?: string;
  value?: string;
...
export class ListMgsApiResponseBodyResultContentValueLimitRule extends $dara.Model {
  defaultResponse?: string;
  i18nResponse?: string;
  interval?: number;
  limit?: number;
...
export class ListMgsApiResponseBodyResultContentValueMigrateRule extends $dara.Model {
  flowPercent?: number;
  needMigrate?: boolean;
...
export class ListMgsApiResponseBodyResultContentValueMockRule extends $dara.Model {
  mockData?: string;
  needMock?: boolean;
  percentage?: number;
  type?: string;
...
export class ListMgsApiResponseBodyResultContentValueRequestParams extends $dara.Model {
  apiId?: string;
  appId?: string;
  defaultValue?: string;
  description?: string;
...
export class ListMgsApiResponseBodyResultContentValue extends $dara.Model {
...
export class ListMgsApiResponseBodyResultContent extends $dara.Model {
  errorMessage?: string;
  success?: boolean;
...
export class ListMgsApiResponseBody extends $dara.Model {
  requestId?: string;
  resultCode?: string;
