...
/**
 */
export class AddMdsMiniConfigResponseBodyResultContentData extends $dara.Model {
  content?: string;
  errorCode?: string;
  requestId?: string;
  resultMsg?: string;
...
export class AddMdsMiniConfigResponseBodyResultContent extends $dara.Model {
...
export class AddMdsMiniConfigResponseBody extends $dara.Model {
  requestId?: string;
  resultCode?: string;
