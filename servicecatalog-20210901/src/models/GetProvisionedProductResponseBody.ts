...
export class GetProvisionedProductResponseBodyProvisionedProductDetail extends $dara.Model {
  /**
   * @remarks
...
export class GetProvisionedProductResponseBody extends $dara.Model {
  /**
   * @remarks
  ...
  validate() {
    if(this.provisionedProductDetail && typeof (this.provisionedProductDetail as any).validate === 'function') {
      (this.provisionedProductDetail as any).validate();
    }
    super.validate();
  }
