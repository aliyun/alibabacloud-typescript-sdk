...
export class DescribeProjectsRequest extends $dara.Model {
  ...
  /**
   * @remarks
   * The pagination token. Do not specify this parameter or set it to an empty string for the first page. To retrieve subsequent pages, pass the nextToken value from the previous response without any modification. If the nextToken value in the response is empty, the last page has been reached.
   * 
   * @example
