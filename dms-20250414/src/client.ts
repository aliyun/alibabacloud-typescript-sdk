...
export default class Client extends OpenApi {
  ...
  async resetAgenticApiKeyWithOptions(request: $_model.ResetAgenticApiKeyRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ResetAgenticApiKeyResponse> {
    ...
    return $dara.cast<$_model.ResetAgenticApiKeyResponse>(await this.callApi(params, req, runtime), new $_model.ResetAgenticApiKeyResponse({}));
  }
   ...
   * @returns ResetAgenticApiKeyResponse
   */
  async resetAgenticApiKey(request: $_model.ResetAgenticApiKeyRequest): Promise<$_model.ResetAgenticApiKeyResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.resetAgenticApiKeyWithOptions(request, runtime);
  }
