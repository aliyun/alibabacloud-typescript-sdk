...
export class DescribeSkillFileUploadSignatureResponseBodyData extends $dara.Model {
  /**
   * @remarks
...
export class DescribeSkillFileUploadSignatureResponseBody extends $dara.Model {
  /**
   * @remarks
   * The response struct.
   */
  data?: DescribeSkillFileUploadSignatureResponseBodyData;
  /**
   * @remarks
   * The error code.
   * 
