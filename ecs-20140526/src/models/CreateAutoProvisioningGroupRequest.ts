...
export class CreateAutoProvisioningGroupRequestLaunchConfigurationSchedulerOptions extends $dara.Model {
...
export class CreateAutoProvisioningGroupRequestLaunchTemplateConfig extends $dara.Model {
  /**
   * @remarks
