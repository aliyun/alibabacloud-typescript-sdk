...
export class DescribeImageComponentsRequest extends $dara.Model {
  ...
  /**
   * @remarks
   * The pagination token. Set this parameter to the value of `NextToken` returned in the previous call to this operation. You do not need to set this parameter for the first request.
   * 
   * @example
   * AAAAAdDWBF2****
   */
  ...
  /**
   * @remarks
   * The resource group ID. When you use this parameter to filter resources, the resource count cannot exceed 1,000.
   * 
