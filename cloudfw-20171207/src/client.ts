...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns DescribeIPSRulesResponse
   */
  async describeIPSRulesWithOptions(request: $_model.DescribeIPSRulesRequest, runtime: $dara.RuntimeOptions): Promise<$_model.DescribeIPSRulesResponse> {
    request.validate();
    let query = { };
    ...
    if (!$dara.isNull(request.attackApps)) {
    ...
    if (!$dara.isNull(request.cve)) {
      query["Cve"] = request.cve;
    }

    if (!$dara.isNull(request.defaultAction)) {
    ...
    if (!$dara.isNull(request.queryModify)) {
    ...
    if (!$dara.isNull(request.ruleLevel)) {
    ...
    return $dara.cast<$_model.DescribeIPSRulesResponse>(await this.callApi(params, req, runtime), new $_model.DescribeIPSRulesResponse({}));
  }
   ...
   * @returns DescribeIPSRulesResponse
   */
  async describeIPSRules(request: $_model.DescribeIPSRulesRequest): Promise<$_model.DescribeIPSRulesResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.describeIPSRulesWithOptions(request, runtime);
  }
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns DescribeTaskDispatchStatusResponse
   */
  async describeTaskDispatchStatusWithOptions(request: $_model.DescribeTaskDispatchStatusRequest, runtime: $dara.RuntimeOptions): Promise<$_model.DescribeTaskDispatchStatusResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.taskId)) {
      query["TaskId"] = request.taskId;
    ...
    return $dara.cast<$_model.DescribeTaskDispatchStatusResponse>(await this.callApi(params, req, runtime), new $_model.DescribeTaskDispatchStatusResponse({}));
  }
   ...
   * @returns DescribeTaskDispatchStatusResponse
   */
  async describeTaskDispatchStatus(request: $_model.DescribeTaskDispatchStatusRequest): Promise<$_model.DescribeTaskDispatchStatusResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.describeTaskDispatchStatusWithOptions(request, runtime);
  }
  ...
  async describeTrafficLogWithOptions(request: $_model.DescribeTrafficLogRequest, runtime: $dara.RuntimeOptions): Promise<$_model.DescribeTrafficLogResponse> {
    ...
    if (!$dara.isNull(request.ruleSourceFinal)) {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns ModifySlsDispatchConfigResponse
   */
  async modifySlsDispatchConfigWithOptions(request: $_model.ModifySlsDispatchConfigRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ModifySlsDispatchConfigResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.detailConfig)) {
    ...
    return $dara.cast<$_model.ModifySlsDispatchConfigResponse>(await this.callApi(params, req, runtime), new $_model.ModifySlsDispatchConfigResponse({}));
  }
   ...
   * @returns ModifySlsDispatchConfigResponse
   */
  async modifySlsDispatchConfig(request: $_model.ModifySlsDispatchConfigRequest): Promise<$_model.ModifySlsDispatchConfigResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.modifySlsDispatchConfigWithOptions(request, runtime);
  }
   ...
   */
  async modifyUserAlarmConfigWithOptions(tmpReq: $_model.ModifyUserAlarmConfigRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ModifyUserAlarmConfigResponse> {
    tmpReq.validate();
    let request = new $_model.ModifyUserAlarmConfigShrinkRequest({ });
    OpenApiUtil.convert(tmpReq, request);
    if (!$dara.isNull(tmpReq.contactConfig)) {
      request.contactConfigShrink = OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.contactConfig, "ContactConfig", "json");
    }
    ...
    if (!$dara.isNull(request.contactConfigShrink)) {
