...
export class UnmountInstanceSDGResponseBodyDataResultFailedItems extends $dara.Model {
  /**
   * @remarks
   * The error message.
   * 
...
export class UnmountInstanceSDGResponseBodyDataResult extends $dara.Model {
  /**
   * @remarks
...
export class UnmountInstanceSDGResponseBodyData extends $dara.Model {
  /**
   * @remarks
