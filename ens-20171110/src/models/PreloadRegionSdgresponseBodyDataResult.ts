...
import { PreloadRegionSDGResponseBodyDataResultFailedItems } from "./PreloadRegionSdgresponseBodyDataResultFailedItems";


export class PreloadRegionSDGResponseBodyDataResult extends $dara.Model {
  /**
   * @remarks
