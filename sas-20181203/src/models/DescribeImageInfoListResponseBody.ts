...
export class DescribeImageInfoListResponseBodyImageInfos extends $dara.Model {
  /**
   * @remarks
   * The number of alerts detected in the current container group, application, namespace, or cluster.
   * 
   * @example
   * 10
   */
   ...
   * - **NO**: The asset does not have security alerts.
   * 
   * @example
   * YES
   */
  ...
  /**
   * @remarks
   * The time when the image was last updated. The value is a UNIX timestamp. Unit: milliseconds.
   * 
   * @example
   * 1636974116000
   */
   ...
   * 
   * - **YES**: The image has security risks.
   * - **NO**: The image does not have security risks.
   * 
   * @example
   * YES
   */
  ...
  /**
   * @remarks
   * The total number of vulnerabilities on your assets.
   * 
   * @example
   * 1
   */
   ...
   * - **NO**: The instance does not have vulnerabilities.
   * 
   * @example
   * YES
   */
