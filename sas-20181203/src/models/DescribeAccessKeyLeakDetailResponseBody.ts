...
export class DescribeAccessKeyLeakDetailResponseBody extends $dara.Model {
  ...
  /**
   * @remarks
   * The time when the AccessKey pair leak event was handled.
   * 
   * @example
   * 2022-01-17 15:47:08
   */
  ...
  /**
   * @remarks
   * The method used to handle the AccessKey pair leak event. Valid values:
   * 
  ...
  /**
   * @remarks
   * The time when the GitHub file was last updated.
   * 
   * @example
   * 2021-07-06T09:49:33
   */
  ...
  /**
   * @remarks
   * The time when the AccessKey pair leak event was first detected.
   * 
   * @example
   * 2021-07-06 17:49:41
   */
  ...
  /**
   * @remarks
   * The most recent time when the leak event was detected.
   * 
   * @example
   * 2021-07-06 17:49:39
   */
