...
export class PublicSyncAndCreateImageScanTaskResponseBodyData extends $dara.Model {
  /**
   * @remarks
...
export class PublicSyncAndCreateImageScanTaskResponseBody extends $dara.Model {
  /**
   * @remarks
