...
export class ListUnfinishedOnceTaskResponseBodyOnceTasksTaskImageInfo extends $dara.Model {
  ...
  /**
   * @remarks
   * The cluster name. This parameter is required to query the instance list of a specific cluster under the service.
   * 
   * @example
   * ACK-test-****
   */
...
export class ListUnfinishedOnceTaskResponseBodyOnceTasks extends $dara.Model {
  /**
   * @remarks
   * The end time. The value is a UNIX timestamp in milliseconds.
   * 
   * @example
   * 1670307567000
   */
  ...
  /**
   * @remarks
   * The task execution time. The value is a UNIX timestamp in milliseconds.
   * 
   * @example
   * 1670307567000
   */
  ...
  /**
   * @remarks
   * The start time. The value is a UNIX timestamp in milliseconds.
   * 
   * @example
   * 1640102400000
   */
  ...
  /**
   * @remarks
   * The total count. This parameter takes effect during paged query with paging.
   * 
   * @example
   * 30
   */
