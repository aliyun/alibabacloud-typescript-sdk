...
export class DescribeAlarmEventDetailResponseBodyData extends $dara.Model {
   ...
   * 
   * - **true**: The mark as false positive can be canceled.
   * 
   * - **false**: The unmark as false positive cannot be performed.
   * 
   * @example
   * false
   */
  ...
  /**
   * @remarks
   * Indicates whether the important activity security assurance mode is enabled.
   * 
   * @example
   * true
   */
