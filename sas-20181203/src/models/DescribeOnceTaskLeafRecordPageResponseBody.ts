...
export class DescribeOnceTaskLeafRecordPageResponseBodyOnceTasksTaskImageInfo extends $dara.Model {
   ...
   * - **sensitiveInfo**: AccessKey detection.
   * - **webshell**: web shell.
   * 
   * @example
...
export class DescribeOnceTaskLeafRecordPageResponseBodyOnceTasks extends $dara.Model {
  ...
  /**
   * @remarks
   * The start execution time. The value is a UNIX timestamp. Unit: milliseconds.
   * 
   * @example
   * 1640102400000
   */
  ...
  /**
   * @remarks
   * The total number of records. This parameter takes effect in a paged query.
   * 
   * @example
   * 30
   */
