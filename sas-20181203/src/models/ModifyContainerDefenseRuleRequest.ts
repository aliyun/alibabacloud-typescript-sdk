...
export class ModifyContainerDefenseRuleRequestScope extends $dara.Model {
  /**
   * @remarks
...
export class ModifyContainerDefenseRuleRequestWhitelist extends $dara.Model {
  /**
   * @remarks
...
export class ModifyContainerDefenseRuleRequest extends $dara.Model {
  /**
   * @remarks
