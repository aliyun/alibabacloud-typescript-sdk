...
export class BatchUpdateMaliciousFileWhitelistConfigRequestConfigList extends $dara.Model {
  /**
   * @remarks
...
export class BatchUpdateMaliciousFileWhitelistConfigRequest extends $dara.Model {
  /**
   * @remarks
   * The whitelist rules.
   */
