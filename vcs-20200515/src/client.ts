...
export class ListNVRDeviceResponseBodyDataChannelList extends $tea.Model {
  deviceCode?: string;
  deviceName?: string;
  deviceType?: string;
  datasourceType?: string;
...
export class ListNVRDeviceResponseBodyData extends $tea.Model {
  ...
  channel?: string;
  deviceSn?: string;
  channelList?: ListNVRDeviceResponseBodyDataChannelList[];
  type?: string;
  static names(): { [key: string]: string } {
    return {
      deviceCode: 'DeviceCode',
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      channel: 'string',
      deviceSn: 'string',
      channelList: { 'type': 'array', 'itemType': ListNVRDeviceResponseBodyDataChannelList },
      type: 'string',
    };
  }
