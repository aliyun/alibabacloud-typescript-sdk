...
import { GetRelatedWorkspacesHeadersAccountContext } from "./GetRelatedWorkspacesHeadersAccountContext";


export class GetRelatedWorkspacesHeaders extends $dara.Model {
