...
import { GetMultiDimTableRecordHeadersAccountContext } from "./GetMultiDimTableRecordHeadersAccountContext";


export class GetMultiDimTableRecordHeaders extends $dara.Model {
