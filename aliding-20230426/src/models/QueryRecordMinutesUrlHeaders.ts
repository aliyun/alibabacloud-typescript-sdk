...
import { QueryRecordMinutesUrlHeadersAccountContext } from "./QueryRecordMinutesUrlHeadersAccountContext";


export class QueryRecordMinutesUrlHeaders extends $dara.Model {
