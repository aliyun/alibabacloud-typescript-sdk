...
import { GetMultiDimTableAllFieldsHeadersAccountContext } from "./GetMultiDimTableAllFieldsHeadersAccountContext";


export class GetMultiDimTableAllFieldsHeaders extends $dara.Model {
