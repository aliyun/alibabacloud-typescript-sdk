...
import { GetSheetContentJobIdHeadersAccountContext } from "./GetSheetContentJobIdHeadersAccountContext";


export class GetSheetContentJobIdHeaders extends $dara.Model {
