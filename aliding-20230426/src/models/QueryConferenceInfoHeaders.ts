...
import { QueryConferenceInfoHeadersAccountContext } from "./QueryConferenceInfoHeadersAccountContext";


export class QueryConferenceInfoHeaders extends $dara.Model {
