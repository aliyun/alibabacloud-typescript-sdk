...
import { GetProcessDefinitionHeadersAccountContext } from "./GetProcessDefinitionHeadersAccountContext";


export class GetProcessDefinitionHeaders extends $dara.Model {
