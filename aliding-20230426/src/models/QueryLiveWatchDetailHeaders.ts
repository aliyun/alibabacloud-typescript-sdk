...
import { QueryLiveWatchDetailHeadersAccountContext } from "./QueryLiveWatchDetailHeadersAccountContext";


export class QueryLiveWatchDetailHeaders extends $dara.Model {
