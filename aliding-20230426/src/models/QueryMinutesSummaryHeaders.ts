...
import { QueryMinutesSummaryHeadersAccountContext } from "./QueryMinutesSummaryHeadersAccountContext";


export class QueryMinutesSummaryHeaders extends $dara.Model {
