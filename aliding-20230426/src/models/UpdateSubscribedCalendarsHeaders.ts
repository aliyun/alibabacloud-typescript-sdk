...
import { UpdateSubscribedCalendarsHeadersAccountContext } from "./UpdateSubscribedCalendarsHeadersAccountContext";


export class UpdateSubscribedCalendarsHeaders extends $dara.Model {
