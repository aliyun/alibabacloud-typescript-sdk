...
import { QueryScheduleConferenceHeadersAccountContext } from "./QueryScheduleConferenceHeadersAccountContext";


export class QueryScheduleConferenceHeaders extends $dara.Model {
