...
import { CreateOrgHonorTemplateHeadersAccountContext } from "./CreateOrgHonorTemplateHeadersAccountContext";


export class CreateOrgHonorTemplateHeaders extends $dara.Model {
