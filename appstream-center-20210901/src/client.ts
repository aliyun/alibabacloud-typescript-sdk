...
export default class Client extends OpenApi {
  ...
  async createModelTemplateWithOptions(request: $_model.CreateModelTemplateRequest, runtime: $dara.RuntimeOptions): Promise<$_model.CreateModelTemplateResponse> {
    ...
    if (!$dara.isNull(request.refScope)) {
   ...
   */
  async listAppsByAppInstanceGroupIdWithOptions(request: $_model.ListAppsByAppInstanceGroupIdRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListAppsByAppInstanceGroupIdResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.appInstanceGroupId)) {
      query["AppInstanceGroupId"] = request.appInstanceGroupId;
    ...
    return $dara.cast<$_model.ListAppsByAppInstanceGroupIdResponse>(await this.callApi(params, req, runtime), new $_model.ListAppsByAppInstanceGroupIdResponse({}));
  }
   ...
   * @returns ListAppsByAppInstanceGroupIdResponse
   */
  async listAppsByAppInstanceGroupId(request: $_model.ListAppsByAppInstanceGroupIdRequest): Promise<$_model.ListAppsByAppInstanceGroupIdResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.listAppsByAppInstanceGroupIdWithOptions(request, runtime);
  }
   ...
   */
  async listAuthorizedAppsByUserWithOptions(request: $_model.ListAuthorizedAppsByUserRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListAuthorizedAppsByUserResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.appId)) {
      query["AppId"] = request.appId;
    ...
    return $dara.cast<$_model.ListAuthorizedAppsByUserResponse>(await this.callApi(params, req, runtime), new $_model.ListAuthorizedAppsByUserResponse({}));
  }
   ...
   * @returns ListAuthorizedAppsByUserResponse
   */
  async listAuthorizedAppsByUser(request: $_model.ListAuthorizedAppsByUserRequest): Promise<$_model.ListAuthorizedAppsByUserResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.listAuthorizedAppsByUserWithOptions(request, runtime);
  }
  ...
  async listDesktopAgentRuntimeWithOptions(request: $_model.ListDesktopAgentRuntimeRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListDesktopAgentRuntimeResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.agentImOnlineStatus)) {
    ...
    if (!$dara.isNull(request.agentPlatformList)) {
    ...
    if (!$dara.isNull(request.agentProviderList)) {
      query["AgentProviderList"] = request.agentProviderList;
    }

    if (!$dara.isNull(request.agentTemplateIds)) {
  ...
  async listLlmTemplatesWithOptions(tmpReq: $_model.ListLlmTemplatesRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListLlmTemplatesResponse> {
    ...
    if (!$dara.isNull(request.smartModel)) {
   ...
   */
  async listPublishedAppInstanceGroupWithOptions(request: $_model.ListPublishedAppInstanceGroupRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListPublishedAppInstanceGroupResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.appId)) {
      query["AppId"] = request.appId;
    ...
    if (!$dara.isNull(request.excludeUserId)) {
    ...
    return $dara.cast<$_model.ListPublishedAppInstanceGroupResponse>(await this.callApi(params, req, runtime), new $_model.ListPublishedAppInstanceGroupResponse({}));
  }
   ...
   * @returns ListPublishedAppInstanceGroupResponse
   */
  async listPublishedAppInstanceGroup(request: $_model.ListPublishedAppInstanceGroupRequest): Promise<$_model.ListPublishedAppInstanceGroupResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.listPublishedAppInstanceGroupWithOptions(request, runtime);
  }
   ...
   */
  async listPublishedAppsWithOptions(request: $_model.ListPublishedAppsRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListPublishedAppsResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.appId)) {
      query["AppId"] = request.appId;
    ...
    return $dara.cast<$_model.ListPublishedAppsResponse>(await this.callApi(params, req, runtime), new $_model.ListPublishedAppsResponse({}));
  }
   ...
   * @returns ListPublishedAppsResponse
   */
  async listPublishedApps(request: $_model.ListPublishedAppsRequest): Promise<$_model.ListPublishedAppsResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    return await this.listPublishedAppsWithOptions(request, runtime);
  }
  ...
  async listWuyingServerWithOptions(request: $_model.ListWuyingServerRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListWuyingServerResponse> {
    ...
    if (!$dara.isNull(request.expiredTimeEnd)) {
      body["ExpiredTimeEnd"] = request.expiredTimeEnd;
    }

    if (!$dara.isNull(request.expiredTimeStart)) {
   ...
   */
  async listZonesWithOptions(request: $_model.ListZonesRequest, runtime: $dara.RuntimeOptions): Promise<$_model.ListZonesResponse> {
    request.validate();
    let query = { };
    if (!$dara.isNull(request.bizRegionId)) {
      query["BizRegionId"] = request.bizRegionId;
