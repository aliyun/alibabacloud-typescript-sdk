...
export class DescribeTaskInfoResponseBodyTarget extends $dara.Model {
  ...
  /**
   * @remarks
   * The object type of the node on which the task is executed.
   * 
   * @example
   * cluster
   */
...
export class DescribeTaskInfoResponseBodyTaskResult extends $dara.Model {
  /**
   * @remarks
   * The resource on which the task operates. For example, if the resource involved in a scale-out task is an instance, this parameter returns the instance ID.
   * 
   * @example
   * i-xxx
   */
   ...
   * - `initial`: The scale-out is being initialized.
   * 
   * @example
   * success
   */
...
export class DescribeTaskInfoResponseBody extends $dara.Model {
  ...
  /**
   * @remarks
   * The current running stage of the task.
   * 
   * @example
   * DrainNodes
   */
  ...
  /**
   * @remarks
   * The task type. The type of a scale-out task is `cluster_scaleout`.
   * 
   * @example
   * cluster_scaleout
   */
