...
export class DescribeNodeGroupRefreshTaskRequest extends $dara.Model {
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      nextToken: 'string',
      nodeGroupRefreshTaskId: 'string',
      nodeStatuses: { 'type': 'array', 'itemType': 'string' },
    };
  }

  validate() {
    if(Array.isArray(this.nodeStatuses)) {
      $dara.Model.validateArray(this.nodeStatuses);
    }
    super.validate();
  }
