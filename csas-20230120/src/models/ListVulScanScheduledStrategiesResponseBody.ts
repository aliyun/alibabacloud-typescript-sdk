...
export class ListVulScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup extends $dara.Model {
  /**
   * @remarks
...
export class ListVulScanScheduledStrategiesResponseBodyStrategies extends $dara.Model {
  /**
   * @remarks
   ...
   */
  customMatchGroup?: ListVulScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      createTime: 'number',
      customMatchGroup: { 'type': 'array', 'itemType': ListVulScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup },
      lastTriggerTime: 'number',
      matchMode: 'string',
...
export class ListVulScanScheduledStrategiesResponseBody extends $dara.Model {
  /**
   * @remarks
   * The request ID.
   * 
   ...
   */
  strategies?: ListVulScanScheduledStrategiesResponseBodyStrategies[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      requestId: 'string',
      strategies: { 'type': 'array', 'itemType': ListVulScanScheduledStrategiesResponseBodyStrategies },
      totalNum: 'number',
    };
  }
