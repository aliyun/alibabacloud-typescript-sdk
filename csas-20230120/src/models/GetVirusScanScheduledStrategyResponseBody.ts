...
export class GetVirusScanScheduledStrategyResponseBodyCustomMatchGroup extends $dara.Model {
  /**
   * @remarks
...
export class GetVirusScanScheduledStrategyResponseBody extends $dara.Model {
  /**
   * @remarks
   ...
   */
  customMatchGroup?: GetVirusScanScheduledStrategyResponseBodyCustomMatchGroup[];
  /**
   * @remarks
  ...
  static types(): { [key: string]: any } {
    return {
      createTime: 'string',
      customMatchGroup: { 'type': 'array', 'itemType': GetVirusScanScheduledStrategyResponseBodyCustomMatchGroup },
      highRiskOperation: 'string',
      lastTriggerTime: 'string',
      lowRiskOperation: 'string',
      matchMode: 'string',
