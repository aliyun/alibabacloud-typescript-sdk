...
export class ListProhibitedSoftwareRequestSoftwareIds extends $dara.Model {
  /**
   * @remarks
...
export class ListProhibitedSoftwareRequestTagId extends $dara.Model {
  /**
   * @remarks
...
export class ListProhibitedSoftwareRequest extends $dara.Model {
  /**
   * @remarks
   ...
   */
  softwareIds?: ListProhibitedSoftwareRequestSoftwareIds[];
  /**
   * @remarks
   * The unique identifier of the prohibited software tag.
   */
  tagId?: ListProhibitedSoftwareRequestTagId;
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      policyId: 'string',
      processName: 'string',
      softwareIds: { 'type': 'array', 'itemType': ListProhibitedSoftwareRequestSoftwareIds },
      tagId: ListProhibitedSoftwareRequestTagId,
    };
  }
  ...
  validate() {
    ...
    if(this.tagId && typeof (this.tagId as any).validate === 'function') {
      (this.tagId as any).validate();
    }
    super.validate();
  }
