...
export class GetQuotaTemplateServiceStatusResponseBodyTemplateServiceStatus extends $dara.Model {
  /**
   * @remarks
...
export class GetQuotaTemplateServiceStatusResponseBody extends $dara.Model {
  /**
   * @remarks
