...
export default class Client extends RPC {
  ...
  async queryDeviceCountWithOptions(request: QueryDeviceCountRequest, runtime: $Util.RuntimeOptions): Promise<QueryDeviceCountResponse> {
    ...
    return $tea.cast<QueryDeviceCountResponse>(await this.doRequest("QueryDeviceCount", "HTTPS", "POST", "2016-08-01", "AK", null, $tea.toMap(request), runtime), new QueryDeviceCountResponse({}));
  }
