...
export default class Client extends OpenApi {
   ...
   */
  async getSessionContentWithOptions(request: $_model.GetSessionContentRequest, headers: {[key: string ]: string}, runtime: $dara.RuntimeOptions): Promise<$_model.GetSessionContentResponse> {
    request.validate();
    ...
    return $dara.cast<$_model.GetSessionContentResponse>(await this.callApi(params, req, runtime), new $_model.GetSessionContentResponse({}));
  }
   ...
   * @returns GetSessionContentResponse
   */
  async getSessionContent(request: $_model.GetSessionContentRequest): Promise<$_model.GetSessionContentResponse> {
    let runtime = new $dara.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.getSessionContentWithOptions(request, headers, runtime);
  }
