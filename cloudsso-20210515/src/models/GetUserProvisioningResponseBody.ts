...
import { GetUserProvisioningResponseBodyUserProvisioning } from "./GetUserProvisioningResponseBodyUserProvisioning";


export class GetUserProvisioningResponseBody extends $dara.Model {
  /**
   * @remarks
   * The request ID.
   * 
