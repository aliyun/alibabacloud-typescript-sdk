...
import { CreateUserProvisioningResponseBodyUserProvisioning } from "./CreateUserProvisioningResponseBodyUserProvisioning";


export class CreateUserProvisioningResponseBody extends $dara.Model {
  /**
   * @remarks
   * The request ID.
   * 
