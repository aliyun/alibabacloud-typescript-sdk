...
import { ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo } from "./ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo";


export class ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice extends $dara.Model {
  /**
   * @example
   * 17400
   */
