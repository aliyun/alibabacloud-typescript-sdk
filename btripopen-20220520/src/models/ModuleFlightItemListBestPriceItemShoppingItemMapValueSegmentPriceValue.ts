...
import { ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo } from "./ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo";


export class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue extends $dara.Model {
  /**
   * @example
   * 17400
   */
