...
export class IntlFlightReShopCreateRequestSelectedPassengers extends $dara.Model {
  fullName?: string;
  passengerId?: number;
...
export class IntlFlightReShopCreateRequest extends $dara.Model {
   ...
   * This parameter is required.
   */
  selectedPassengers?: IntlFlightReShopCreateRequestSelectedPassengers[];
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      passengerJourneyGroupKey: 'string',
      reShopReasonCode: 'string',
      selectedPassengers: { 'type': 'array', 'itemType': IntlFlightReShopCreateRequestSelectedPassengers },
      totalReShopFee: 'number',
    };
  }
