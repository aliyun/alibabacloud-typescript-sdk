...
import { ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo } from "./ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo";


export class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue extends $dara.Model {
  /**
   * @example
   * 17400
   */
