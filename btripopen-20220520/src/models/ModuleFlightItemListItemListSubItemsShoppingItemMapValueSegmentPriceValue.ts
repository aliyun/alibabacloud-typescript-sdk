...
import { ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo } from "./ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo";


export class ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue extends $dara.Model {
  /**
   * @example
   * 17400
   */
