...
export class DescribeFlowResponseBodyEnvironmentVariables extends $dara.Model {
  /**
   * @example
   * description
   */
...
export class DescribeFlowResponseBodyEnvironment extends $dara.Model {
  variables?: DescribeFlowResponseBodyEnvironmentVariables[];
  static names(): { [key: string]: string } {
    return {
      variables: 'Variables',
    };
  ...
  static types(): { [key: string]: any } {
    return {
      variables: { 'type': 'array', 'itemType': DescribeFlowResponseBodyEnvironmentVariables },
    };
  }
...
export class DescribeFlowResponseBody extends $dara.Model {
   ...
   */
  description?: string;
  environment?: DescribeFlowResponseBodyEnvironment;
  /**
   * @remarks
