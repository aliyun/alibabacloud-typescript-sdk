...
export class QueryApmGrafanaDataRequestQueryParams extends $dara.Model {
  /**
   * @remarks
   * The panel ID.
   * 
...
export class QueryApmGrafanaDataRequest extends $dara.Model {
  /**
   * @remarks
   ...
   */
  queryParams?: QueryApmGrafanaDataRequestQueryParams;
  /**
   * @remarks
